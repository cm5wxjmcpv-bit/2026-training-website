...
const DEFAULT_CLASSES = [
  {
    id: DEFAULT_CLASS_ID,
    title: "Class A and B",
    description: "CDL Class A/B ELDT training",
    passingScore: 80,
  ...
  },
  {
    ...
    description: "Upgrade training from Class B to Class A",
    passingScore: 80,
    requiredWatchPercent: 0.9,
    sortOrder: 2,
    active: false,
  },
  {
    ...
    description: "Passenger endorsement training",
    passingScore: 80,
    requiredWatchPercent: 0.9,
    sortOrder: 3,
    active: false,
  },
  {
    ...
    description: "School bus endorsement training",
    passingScore: 80,
    requiredWatchPercent: 0.9,
    sortOrder: 4,
    active: false,
  },
  {
    ...
    description: "Tanker endorsement training",
    passingScore: 80,
    requiredWatchPercent: 0.9,
    sortOrder: 5,
    active: false,
  },
  {
    ...
    description: "Hazmat endorsement training",
    passingScore: 80,
    requiredWatchPercent: 0.9,
    sortOrder: 6,
    active: false,
...
const DEFAULT_MODULES = (typeof MODULES !== "undefined" ? MODULES : []).map(
  (m, index) => ({
    ...
    requiredWatchPercent:
      typeof REQUIRED_WATCH_PERCENT !== "undefined"
...
async function apiListClasses(activeOnly = false) {
  return apiGet("listClasses", { activeOnly: activeOnly ? "true" : "" });
}
async function apiListModules(classId = "", activeOnly = false) {
  return apiGet("listModules", {
    classId,
